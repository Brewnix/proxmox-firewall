...
| **Workloads** | [workloads/](workloads/) | Guests on Proxmox (`bpg/proxmox`), OPNsense API (`browningluke/opnsense`), and guest Ansible (e.g. apply LXC snippets after apply). |
...
- **[workloads/terraform/README.md](workloads/terraform/README.md)** — OPNsense VM, LXCs, rendered `#cloud-config` snippets on the node.
